...
- Перейти на <https://openweathermap.org/> и получить api-ключ (это бесплатно). В файле, *constants.ts* который находится по пути src -> shared -> api заменить значение константы API_KEY на свое.
